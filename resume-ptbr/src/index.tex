...
\resumeItem{Trabalhei no desenvolvimento dos sites da empresa, criação de novos módulos/endpoints, armazenamento dos dados utilizando PostgreSQL e integração das rotas no front-end com Angular;}
\resumeItem{Migração de API não-restfull para restfull;}
\resumeItem{Sistema é utilizado principalmente por postos de combustíveis ao redor do Brasil contando com com mais de milhares de clientes;}
\resumeItemListEnd
