...
\resumeItem{Trabalhei no desenvolvimento dos sites da empresa, criação de novos módulos/endpoints, armazenamento do dados utilizando PostgreSQL e integração das rotas no front-end com Angular;}
